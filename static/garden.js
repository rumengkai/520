...
function Petal(stretchA, stretchB, startAngle, angle, growFactor, bloom) {
		...
		// Garden.degrad(Garden.options.tanAngle)); this.tanAngleB =
		// Garden.random(-Garden.degrad(Garden.options.tanAngle),
...
Petal.prototype = {
		draw: function () {
				...
				v3 = v1
						.clone()
						.mult(this.stretchA); //.rotate(this.tanAngleA);
				v4 = v2
						.clone()
						.mult(this.stretchB); //.rotate(this.tanAngleB);
...
Bloom.prototype = {
		...
		init: function () {
				...
				for (var i = 0; i < this.pc; i++) {
						this
								.petals
								.push(new Petal(Garden.random(Garden.options.petalStretch.min, Garden.options.petalStretch.max), Garden.random(Garden.options.petalStretch.min, Garden.options.petalStretch.max), startAngle + i * angle, angle, Garden.random(Garden.options.growFactor.min, Garden.options.growFactor.max), this));
				}
		}
}
